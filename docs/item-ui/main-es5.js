...
var ItemBean = /** @class */ (function () {
    function ItemBean(itemId, itemLabel) {
        this.itemId = itemId;
        this.itemLabel = itemLabel;
    }
    ItemBean.ctorParameters = function () { return [
        { type: Number },
        { type: String }
    ]; };
    return ItemBean;
...
var ItemService = /** @class */ (function () {
    ...
    ItemService.prototype.getItemById = function (id) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/items", { id: id })
...
var ItemListComponent = /** @class */ (function () {
    ...
    ItemListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.itemService.getAllItems().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).subscribe(function (users) {
            _this.items = users;
        });
    };
...
var ItemComponent = /** @class */ (function () {
    function ItemComponent(activatedRoute, itemService) {
    ...
    ItemComponent.prototype.loadData = function () {
        ...
        this.activatedRoute.paramMap.subscribe(function (params) {
            ...
            _this.loadItemDetails(Number(_this.itemId));
        });
    };
    ItemComponent.prototype.loadItemDetails = function (itemId) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, route, router, authenticationService, userIdle) {
    ...
    LoginComponent.prototype.stop = function () {
        this.userIdle.stopTimer();
    };
    LoginComponent.prototype.stopWatching = function () {
        this.userIdle.stopWatching();
    };
    LoginComponent.prototype.startWatching = function () {
        this.userIdle.startWatching();
    };
    LoginComponent.prototype.restart = function () {
